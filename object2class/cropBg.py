...
# 样本图片路径
imgPath = 'D:\code\Makedataset\object2class\\beijing'
# 样本图片标签
...
defectPath = 'output\\defect' # 该参数对背景做裁时用不到
...
class obejct2cls(object):
    def __init__(self,imgPath,xmlPath=None):
        '''
...
if __name__ == "__main__":
    ...
    for i in range(len(imglist)):
        ...
        ob2cls = obejct2cls(image_input_fullname)
        ob2cls.bg_crop()
